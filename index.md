...
---
<div id="sketch-holder" style="display: flex; align-items: center; justify-content: center; width: 400px; height: 400px; padding: 20px; margin: 20px;"></div>
<div class="header" style="display: flex; align-items: center; justify-content: center; width: 400px; height: 200px; padding: 20px; margin: 20px;">
    ...
    <div style="width: 50%; display: block">
        <div style="padding: 10px; margin: 10px;">
            <img src="./FabianMeyer_Portrait_small.jpg" alt="Portrait">
        </div>
    </div>
</div>